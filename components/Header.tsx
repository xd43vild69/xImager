...
const Header: React.FC<HeaderProps> = ({ selectedWorkflow, onWorkflowChange, currentView }) => {
  return (
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="w-full max-w-sm">
          <label className="relative block">
            ...
            >
              <option>SDXL_Image_Enhancer_v4.json</option>
              <option>Text_to_Video_StableVideo.json</option>
              <option>ControlNet_Canny_Face.json</option>
            </select>
